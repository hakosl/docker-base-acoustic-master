...
if __name__ == "__main__":
    ...
    path_model_params = '/nr/project/bild/Cogmar/usr/obr/model/unet_bn_sequential_1_27_compare_07.pt'

    ### PLOT ECHOGRAM WITH PREDICTIONS ###
    # This generates plots (sequentially) with echogram, labels and predictions
    ### Uncomment and run script ###
    #plot_echograms_with_sandeel_prediction(year=2018, device=device, path_model_params=path_model_params, ignore_mode='normal')
