...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.mu = nn.Linear(opt.layer_size, opt.latent_dim + opt.categories)
        self.logvar = nn.Linear(opt.layer_size, opt.latent_dim + opt.categories)
...
class CategoricDiscriminator(nn.Module):
    def __init__(self):
        super(CategoricDiscriminator, self).__init__()
...
def save_recon(original_image, reconstruction, batches_done, nrow):
    print(f"reconshape {reconstruction.shape}")
